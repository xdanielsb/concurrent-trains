...
public class ControlRailway {
  ...
  /**
   * The lines of the railway. A line is an abstract structure representing two stations and the
   * rails in between, with a given fixed direction. The first line is considered to be the most
   * left.
   */
  private Line[] lines;
  ...
  /**
   * Gives the index of the line in which the station 'src' is. Since a station is in two lines
   * (except for the first and last one), only returns the index of the most left line.
   *
  ...
  /**
   * Gives the total number of trains currently in the railway, based on the length of the trains
   * table.
   *
