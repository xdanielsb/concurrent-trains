package test;
/**
 * @author SANYAS Guillem SANTOS Daniel
 *     <p>Launcher of the application, simulate the behaviour of trains over a railway with n
 *     stations and n trains, the number of trains and stations have a limit due to the size of the
 *     screen.
 */
...
public class TestNStations {
  ...
  /**
   * Set a destiny of the train, the origin should be set to call this operation
   *
   * @param t train
   */
  ...
  /** Base Logic to create a pseudo-random configuration for n-trains and m- stations */
  public void start() {
    ...
    try {
      ...
      ctrl.addLines(lines);
      for (Train t : trains) setPRandomDestiny(t);
      ctrl.createWindow();
    } catch (Exception ex) {
