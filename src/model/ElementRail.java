...
/**
 * Abstraction of the concrete elements of the railway : {Station,Section}.
 *
...
public abstract class ElementRail {
  ...
  /**
   * If the method is fully executed it means that a train can land in this element. Otherwise train
   * awaits.
   */
  public abstract void arrive();

  /** Activated when a train leaves the element. Releases the other trains from their sleep. */
  public abstract void leave();

  /**
   * Gives the coordinates of the elements for diplay purposes.
   *
