...
/**
 * Class representing a train in the railway. Every train is a separate thread.
 *
...
public class Train extends Thread {
  ...
  /** Direction of the current train, calculated with origin and destiny */
  private Direction direction;
  /**
   * Monitor, that is synchronized with other trains in the same portion of the railway (called
   * line).
   */
  ...
  /** The entire railway system, that is used to switch between lines at a given station. */
   ...
   * @param line : the line in which the train is initially set. The origin must always be a station
   *     of this line.
  ...
  /** Makes the train advance in the railway. It is the brain of the simulation. */
  ...
  /**
   * Find the direction for which the train should go.
   *
  ...
  public void findDirection() {
    ...
    // have to go
    direction = ctrl.getIndex(origin) < ctrl.getIndex(destiny) ? Direction.LR : Direction.RL;
    cord.setX(origin.getCord().getX());
    System.out.println(origin + " to " + destiny + " dir= " + direction);
  }

  /**
   * Getter for the coordinates of the train, used for display.
   *
  ...
  /**
   * Setter for the coordinates of the train, used for display.
   *
  ...
  /**
   * Getter for the current direction in which the train is going.
   *
  ...
  /**
   * Get the line is which is moving the train who calls the method.
   *
   * @return Line
   */
